package utils
{
	 ...
	 * @author spirit2
	 */
	public class ButtonSoundImage extends Sprite
	{
		...
		private var _isMisucButton:Boolean = false;
		private var _isDown:Boolean;
		
		public function ButtonSoundImage(image:BitmapData, image2:BitmapData, imageHover:BitmapData = null, imageHover2:BitmapData = null, isMisucButton:Boolean = false)
		{
			buttonMode = true;
			mouseChildren = false;
			_isMisucButton = isMisucButton;
			...
			if (_isMisucButton)
				SoundManager.getInstance().currentMusicButton = this;
			else
				SoundManager.getInstance().currentSoundButton = this;
		}
		...
		private function setState():void
		{
			if (_isMisucButton)
				...
				_isActive = SoundManager.getInstance().isSFX;
		...
		{
			if (_isMisucButton)
				SoundManager.getInstance().currentMusicButton = null;
			else
				SoundManager.getInstance().currentSoundButton = null;
